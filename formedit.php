...
<body>
  ...
  <form class="form-style-5" action = "edit.php" method = "post" id="EditForm" >
    ...
    Name:<br>
    <input type="text" name = "Name" id="idName" placeholder="Enter Name" style="width: 484px; padding: 5px;" value="<?php echo $result["Name"];?>"> <br>
    Comment:<br>
    <textarea rows="10" cols="66" name = "Comment" id="idComment" placeholder="Enter Comment" value="<?php echo $result["Comment"];?>"></textarea><br>
    Link:<br>
    <input type="text" name = "Link" id="idLink" placeholder="Enter Link" style="width: 484px; padding: 5px;" value="<?php echo $result["Link"];?>"> <br><br>
