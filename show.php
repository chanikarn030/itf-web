...
<form action = "delete.php" method = "post" id="Delete">
  <div class="center1"><input type="submit" id="deletedata" style="padding: 12px; border-width: 0cm; background-color: lightsalmon; color: white; border-radius: 12px;" value="ADD"></div>
</form>
<?php
mysqli_close($conn);
?>
